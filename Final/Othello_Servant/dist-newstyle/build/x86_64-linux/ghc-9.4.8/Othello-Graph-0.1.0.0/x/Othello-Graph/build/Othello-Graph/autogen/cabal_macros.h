...
/* package Othello-Graph-0.1.0.0 */
#ifndef VERSION_Othello_Graph
#define VERSION_Othello_Graph "0.1.0.0"
#endif /* VERSION_Othello_Graph */
#ifndef MIN_VERSION_Othello_Graph
#define MIN_VERSION_Othello_Graph(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Othello_Graph */
...
#define CURRENT_COMPONENT_ID "Othello-Graph-0.1.0.0-inplace-Othello-Graph"
